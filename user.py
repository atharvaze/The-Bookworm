...
class User:
	def __init__(self,flag):
		...
		##################3functions######################
		def exit():
			exit=tkinter.messagebox.askyesno("The Bookworm","Confirm if you want to exit")
			if exit>0:
				flag.destroy()
				return 
		...
		def issuebook():
			...
			if cursor.fetchall():
				...
				tkinter.messagebox.showinfo("The Bookworm", "Enter Valid details!")
		...
		def check():
			...
			if cursor.fetchall():
				tkinter.messagebox.showinfo("The Bookworm", "Book Issued !")
				delete()
				addbooktouser()
			else:
				tkinter.messagebox.showinfo("The Bookworm", "Return your book first!")
		...
		def return_book():
			...
			if cursor.fetchall():
				...
				tkinter.messagebox.showinfo("The Bookworm", "Returned book successfully!")
			else:
				tkinter.messagebox.showinfo("The Bookworm", "You have no such book!")
		...
		self.lbltitle=Label(TitleFrame,width=39,font=('Broadway',40,'bold'),text="\tThe Bookworm\t",padx=12)
		self.lbltitle.grid()
