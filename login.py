...
class Login:
	def __init__(self,root):
		...
		def database():
   			...
   			conn.commit()
   			tkinter.messagebox.showinfo("The Bookworm", "Details saved successfully!")
		...
		def query():
   			...
   			if cursor.fetchall():
   				tkinter.messagebox.showinfo("The Bookworm", "Welcome User!")
   				root.destroy()
   				import user
		...
		def adminquery():
   			...
   			if cursor.fetchall():
   				tkinter.messagebox.showinfo("The Bookworm", "Welcome Admin!")
   				root.destroy()
   				import admin

   			else:
   				tkinter.messagebox.showinfo("The Bookworm", "Not an Admin!")
